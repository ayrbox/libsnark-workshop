...
Json::Value to_json(r1cs_ppzksnark_proof proof) {
  ...
  proof_in_json[0] = g1(proof.g_A.g);
  proof_in_json[1] = g1(proof.g_A.h);
  proof_in_json[2] = g2(proof.g_B.g);
  proof_in_json[3] = g1(proof.g_B.h);
  proof_in_json[4] = g1(proof.g_C.g);
  proof_in_json[5] = g1(proof.g_C.h);
  proof_in_json[6] = g1(proof.g_H);
  proof_in_json[7] = g1(proof.g_K);
